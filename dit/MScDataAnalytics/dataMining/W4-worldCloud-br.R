...
data1 <- htmlToText("file:///Users/bambrozi/workspace/github.com/bambrozio/academic-corner/dit/MScDataAnalytics/dataMining/bolsonaro.html")
data2 <- htmlToText("file:///Users/bambrozi/workspace/github.com/bambrozio/academic-corner/dit/MScDataAnalytics/dataMining/lula.html")
...
tm_map <- tm_map (tm_map, removeWords, stopwords(kind = "pt")) # to remove stop words(like ‘as’ ‘the’ etc….)
